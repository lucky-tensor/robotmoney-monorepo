...
2. **Paste this prompt** into the agent session:
   ...
   The agent reads [BOOTSTRAP.md](https://github.com/robotmoney/robotmoney-core/blob/7ad48f9065de8dddbe6591f3819711a68aaed6b6/BOOTSTRAP.md), installs `rmpc`, writes the operator config, creates a keystore, runs self-check, and returns its public address for you to authorize in the dapp.
...
- [Architecture proposal](https://github.com/robotmoney/robotmoney-core/blob/7ad48f9065de8dddbe6591f3819711a68aaed6b6/docs/architecture.md)
- [Plan tracking issue](https://github.com/lucky-tensor/robotmoney-monorepo/issues/109)
- [Smart-contract reference](https://github.com/robotmoney/robotmoney-core/blob/7ad48f9065de8dddbe6591f3819711a68aaed6b6/docs/technical/smart-contracts.md)
- [Testing strategy](https://github.com/robotmoney/robotmoney-core/blob/7ad48f9065de8dddbe6591f3819711a68aaed6b6/docs/development/testing-strategy-ethereum.md)
- Vault on BaseScan: https://basescan.org/address/0x4f835c9f54bcf17daf9040f60cb72951ccbb49dd

## License

Apache-2.0. See [LICENSE](https://github.com/robotmoney/robotmoney-core/blob/7ad48f9065de8dddbe6591f3819711a68aaed6b6/LICENSE).
